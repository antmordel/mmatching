...
package es.uma.lcc.mmatching.maude.exceptions;

public class MaudeNoSolutionFoundException extends MaudeProcessException{


	private static final long serialVersionUID = 1L;

	public MaudeNoSolutionFoundException(String message) {
		super(message);
	}
