...
public class MaudeProcess {
	 ...
	 */
	public void loadInfrastructure() throws JobFailedException, ParseException, MaudeErrorException, MaudePrefsException, IOException {
		loadFileInternal("definitions.maude");
		loadFileInternal("ecore.maude");
		loadFileInternal("mmatching.maude");
	}
	...
	private String loadFileInternal(String filePath) throws MaudeErrorException, MaudePrefsException, IOException,
		...
		URL urlArchivo = Resources.class.getResource(filePath);
