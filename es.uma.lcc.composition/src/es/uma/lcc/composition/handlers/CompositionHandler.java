...
import es.uma.lcc.composition.wizard.CompositionWizard;

public class CompositionHandler extends AbstractHandler {
	/**
	 * The constructor.
	 */
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		WizardDialog wizardDialog = new WizardDialog(window.getShell(), new CompositionWizard());
